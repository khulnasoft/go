package main // import "github.com/khulnasoft/go/go-langserver"
...
import (
	...
	"github.com/khulnasoft/go/go-langserver/debugserver"
	"github.com/khulnasoft/go/go-langserver/tracer"
	"github.com/khulnasoft/go/go-langserver/vfsutil"

	"github.com/prometheus/client_golang/prometheus"

	"github.com/gorilla/websocket"
	"github.com/khulnasoft/go/go-langserver/buildserver"
	"github.com/khulnasoft/go/go-langserver/langserver"
	"github.com/khulnasoft/go/jsonrpc2"
	wsjsonrpc2 "github.com/khulnasoft/go/jsonrpc2/websocket"
...
func run(cfg langserver.Config) error {
	...
	if *useBuildServer {
		...
		// https://github.com/khulnasoft/khulnasoft/issues/6090
...
//
// This function should only be invoked in editor mode, not in khulnasoft.com
// mode, because users running the language server as part of their editor
// generally expect much lower memory usage. In contrast, on khulnasoft.com we
