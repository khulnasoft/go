...
class GoLangserver < Formula
  ...
  homepage "https://github.com/khulnasoft/go/go-langserver"
  url "https://github.com/khulnasoft/go/go-langserver/archive/v1.0.0.tar.gz"
  sha256 "e803e69f3df40e6e840d04f648e27ffcfb382ff77899c0c7a7b62cf3b3b277a4"

  head "https://github.com/khulnasoft/go/go-langserver.git"
  ...
  go_resource "github.com/khulnasoft/go/ctxvfs" do
    url "https://github.com/khulnasoft/go/ctxvfs.git",
      :revision => "8e2bd62a565a647defd704af3d81fce05c5f190c"
  end

  go_resource "github.com/khulnasoft/go/jsonrpc2" do
    url "https://github.com/khulnasoft/go/jsonrpc2.git",
  ...
  def install
    mkdir_p buildpath/"src/github.com/khulnasoft"
    ln_s buildpath, buildpath/"src/github.com/khulnasoft/go/go-langserver"
