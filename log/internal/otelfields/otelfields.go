...
type Resource struct {
	...
	Namespace string
	// Version is the version string of the service API or implementation. For Khulnasoft
	// services, this should be from 'internal/version.Version()'
	Version string
	// InstanceID is the string ID of the service instance. For Khulnasoft services, this
