...
//
// 	// vanilla LSP
// 	github.com/khulnasoft/go-langserver/pkg/lsp
//
// 	// proxy (http gateway) server LSP extensions
// 	github.com/khulnasoft/khulnasoft/xlang
//
// 	// (this package) build/lang server LSP extensions
// 	github.com/khulnasoft/khulnasoft/xlang/lspx
//
package lspext
...
type DependencyReference struct {
	...
	// Hints is treated as an opaque object and passed directly by Khulnasoft
	...
	//
	// If a language server emits no hints, Khulnasoft will pass none as a
